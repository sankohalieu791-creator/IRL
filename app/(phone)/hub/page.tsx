      ...
      {showMusicPicker && (
        ...
        >
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "0 16px 16px" }}>
            {musicLoading && <p style={{ color: "#71717a", textAlign: "center", padding: 32, fontSize: 13 }}>Searching...</p>}
            {!musicLoading &&
              tracks.map((track) => (
                <div
                  key={track.id}
            ...
            posts.map((post) => (
              ...
              >
                ...
                >
                  ...
                  >
                    <p style={{ color: "rgba(255,255,255,0.65)", fontSize: 11.5, marginBottom: 8 }}>
                    ...
                    <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                      <button
                        ...
                        style={{
                          ...
                          boxShadow: tried.includes(post.id) ? "none" : "0 4px 20px rgba(180,0,255,0.4)",
                        }}
                      >
