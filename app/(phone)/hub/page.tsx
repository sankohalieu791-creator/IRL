...
export default function Hub() {
  ...
  return (
    <div className="w-full h-screen bg-black flex flex-col overflow-hidden">
      ...
      <div className="flex-shrink-0 px-4 pt-4 pb-3 border-b border-zinc-800 bg-black">
        <div className="mb-3">
          ...
          <div className="flex flex-col">
            {posts.map(post => (
              <div
                ...
                className="relative w-full flex-shrink-0 overflow-hidden bg-zinc-900 snap-start"
              ...
              >
                ...
                {post.media_type === "video" && (
                  <button
                    ...
                    className="absolute top-4 right-20 z-20 bg-black/50 hover:bg-black/70 rounded-full p-2 transition-all"
                  >
                    {mutedPosts[post.id] ? (
                  ...
                  <div className="flex gap-3 items-center pb-4">
                    {!tried.includes(post.id) ? (
                      <button
                        ...
                        className="px-8 py-3 rounded-full bg-gradient-to-r from-cyan-400 to-blue-400 text-black font-bold text-base hover:shadow-lg hover:shadow-cyan-400/50 transition-all"
                      >
                        TRY IRL
                      </button>
                    ) : (
                      <span className="text-cyan-400 font-bold text-base">✓ Tried</span>
                    )}

                    {/* Tried count badge */}
                    <div className="flex items-center gap-2 bg-black/60 backdrop-blur-sm px-4 py-3 rounded-full">
