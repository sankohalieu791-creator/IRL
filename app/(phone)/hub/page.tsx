        ...
        <div style={{ display: "flex", gap: 6, overflowX: "auto", flex: 1, scrollbarWidth: "none" as any }}>
          {filters.map((f) => (
            <button key={f} onClick={() => setFilter(f)} style={{
              ...
              background: filter === f ? "linear-gradient(135deg,#B400FF,#00D4FF)" : "rgba(255,255,255,0.15)",
      ...
      <div style={{
        ...
        {!loading && posts.length === 0 && (
          <div style={{
            ...
            <p style={{ color: "white", fontWeight: 700, fontSize: 16, marginBottom: 8 }}>Hub is empty</p>
            <p style={{ color: "#52525b", fontSize: 13, marginBottom: 24 }}>Complete a session and share it to be first!</p>
            <button onClick={() => router.push("/sessions")} style={{
              padding: "12px 24px", background: "linear-gradient(to right,#B400FF,#00D4FF)",
              borderRadius: 12, color: "white", fontWeight: 700, fontSize: 13,
              border: "none", cursor: "pointer"
            }}>⚡ Go Complete a Session</button>
          </div>
        )}
          ...
          >
            ...
            <div style={{ position: "absolute", bottom: 80, left: 16, right: 16, zIndex: 10 }}>
              ...
              <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
                ...
                <div style={{
                  flex: 1, background: "rgba(39,39,42,0.9)",
